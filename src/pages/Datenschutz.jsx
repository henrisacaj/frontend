  ...
  return (
    <>
      ...
      <div className="container max-w-[1570px] mx-auto pt-16 px-6">
        <h1 className="text-5xl">Datenschutzerklärung</h1>
        <br />
        <div className="space-y-2">
          <h2 className="text-3xl">1. Datenschutz auf einen Blick</h2>
          <h3 className="text-2xl">Allgemeine Hinweise</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl">Datenerfassung auf dieser Website</h3>{" "}
        ...
        <br />
        <div className="space-y-2">
          <h2 className="text-3xl">2. Hosting</h2>
          <br />
          <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
          <h3 className="text-2xl">Externes Hosting</h3>{" "}
          <p>
        ...
        <div className="space-y-2">
          ...
          <h3 className="text-2xl">Hinweis zur verantwortlichen Stelle</h3>{" "}
          <p>
          ...
          <p>
            Telefon: +49 (0) 176 30367555
            <br />
            E-Mail: info@sacaj-baudesign.de
          </p>
          <p>
          ...
          <h3 className="text-2xl">Speicherdauer</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl">Empfänger von personenbezogenen Daten</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl">Auskunft, Berichtigung und L&ouml;schung</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl">Recht auf Einschr&auml;nkung der Verarbeitung</h3>{" "}
          <p>
        ...
        <div className="div space-y-2">
          ...
          <br />
          <h3 className="text-2xl">Kontaktformular</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl">Anfrage per E-Mail, Telefon oder Telefax</h3>{" "}
          <p>
        ...
        <div className="space-y-2">
          <h2 className="text-3xl">5. Plugins und Tools</h2>
          <br />
          <h3 className="text-2xl">Google Fonts</h3>{" "}
          <p>
